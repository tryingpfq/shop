...
<script>
   function change(){
	   ...
	   img1.scr="${pageContext.request.contextPath}/checkImg.action?"+new Date().getTime();
   }
</script>
</head>
<body>
					...
					<form id="loginForm" action="${ pageContext.request.contextPath }/user_login.action"  method="post" novalidate="novalidate">
						<table>
							...
							<tr>
								<th>验证码:</th>
								<td>
								     <input type="text" id="checkCode" name="checkcode" class="text" maxlength="10" autocomplete="off"/>
								</td>
							</tr>
							<tr>
								<th>&nbsp;		
							    ...
							    <td>
								  <img id="checkImg" src="${pageContext.request.contextPath }/checkImg.action" alt="验证码"/>
