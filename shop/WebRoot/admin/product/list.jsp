							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator value="pageBean.list" var="p" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath }/adminProduct_delete.action?pid=<s:property value="#p.pid"/>" onclick="return delete1()">
					...
					<tr align="center">
					   <td class="ta_01" align="center" bgColor="#afd1f3">
					    ...
					    <s:if test="pageBean.page<pageBean.totalPage">
					        ...
					        <a href="${pageContext.request.contextPath }/adminProduct_findAll.action?page=<s:property value="pageBean.totalPage"/>">末页</a>
					    </s:if>
					   </td>
					</tr>
				</TBODY>
