	   ...
	   function showDetail(oid){
		   ...
		   if(but.value =="订单详情"){
			 //创建异步加载对象
			   ...
			   //打开连接
			   xhr.open("GET","${pageContext.request.contextPath}/adminOrder_findOrderItem.action?time="+new Date()+"&oid="+oid,true);
			   //发送
			   xhr.send(null);
			   but.value="关闭";
		   }else{
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator value="pageBean.list" var="order" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<s:if test="#order.state==2">
												  <a href="${pageContext.request.contextPath }/adminOrder_updateState.action?oid=<s:property value="#order.oid"/>"><font color="blue">待发货</font></a>
												</s:if>
