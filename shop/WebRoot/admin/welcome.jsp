...
<form name="Form1" method="post" action="name.aspx" id="Form1" target="_parent">
	...
	<table width="100%" border="0" height="88" border="1" background="${pageContext.request.contextPath}/images/back1.JPG">
		...
		<tr>
			<td width="65%" height="84" align="center" valign="top" >
		    	...
		    	<s:else>
		    	   <span class="Style1">还未登录，请去<a href="${pageContext.request.contextPath }/admin/index.jsp">登录</a></span>
		    	</s:else>
			</td>
		</tr>
